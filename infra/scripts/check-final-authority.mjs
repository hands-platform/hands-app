...
function checkNoContradictoryNegativeWalletWording() {
  const forbiddenPhrases = [
    ...
    'block new booking acceptance',
    'block booking acceptance',
    'blocking new booking acceptance',
    'blocking booking acceptance',
    'booking acceptance should stay blocked',
    'booking acceptance is blocked',
    'Booking acceptance is blocked',
    'Booking acceptance blocked',
    'Booking acceptance on hold',
    'cannot accept bookings until',
    'Cannot accept bookings until',
    'cannot accept more work until',
    'block future acceptance',
    'blocks future acceptance',
    'block further acceptance',
    'blocks partner acceptance',
    'before new booking acceptance',
    'before more booking acceptance',
