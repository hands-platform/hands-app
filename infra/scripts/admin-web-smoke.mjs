...
const pages = [
  ...
  { path: '/bookings?view=first-pick', markers: ['Booking Monitor', 'Stage 1 first-pick'] },
  {
    ...
    markers: [
      ...
      'Negative wallet partners can see marketplace requests but cannot participate',
  ...
  { path: '/notifications?review=no-show', markers: ['Notifications', 'No-show'] },
  {
    ...
    markers: [
      ...
      'Partners can see marketplace requests, but cannot participate in marketplace bookings while the wallet is negative',
...
if (bookingLinkMatch) {
  ...
  const bookingMarkers = [
    ...
    'Marketplace radius',
    'Partner app message: Unpaid HANDS fees must be settled before you can participate in marketplace bookings.',
    'Payment and refund',
