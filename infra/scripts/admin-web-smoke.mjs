...
const pages = [
  {
    path: '/',
    markers: ['HANDS Admin', 'Shift command briefing', 'Partner dispatch control', 'Matching ops', 'API source'],
  },
  {
    path: '/bookings',
    markers: [
  ...
  { path: '/bookings?view=matching', markers: ['Booking Monitor', 'Matching ops'] },
  ...
  { path: '/bookings?view=no-show', markers: ['Booking Monitor', 'No-show'] },
  {
    ...
    markers: ['Operations Policy', 'Booking acceptance control matrix', 'Live matching policy', 'Change reason'],
  },
