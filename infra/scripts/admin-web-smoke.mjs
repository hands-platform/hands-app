...
const pages = [
  ...
  },
  {
    ...
    markers: ['Completed Services', 'Needs action', 'History', 'Search bookings', 'All payment exceptions'],
  },
  {
  ...
  {
    path: '/coupons',
    markers: ['Coupons', 'Create coupon', 'Live checkout codes', 'Coupon list'],
  },
  {
    path: '/earnings',
    markers: [
  ...
  {
    path: '/reviews',
    markers: ['Customer Reviews', 'Review controls', 'Search reviews', 'Submitted date', 'Review queue', 'Export'],
  },
  {
    path: '/notifications',
  ...
  },
  {
    ...
    markers: [
      ...
      'Cancellation share',
      'Paid volume',
      'Regional outcome sample',
      'National KPI cards use exact aggregate queries.',
    ],
  },
  {
