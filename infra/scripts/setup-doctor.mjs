  ...
  JSON.stringify(
    {
      ...
      nextSteps: ok
        ? [
            ...
            'After downloading Firebase service account JSON, run npm.cmd run fcm:credentials:install -- -SourcePath <downloaded-json>, then npm.cmd run fcm:credentials-check.',
