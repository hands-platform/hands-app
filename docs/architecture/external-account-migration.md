...
| Supabase   | `hands-staging` created, SQL applied, storage buckets verified, API exchange smoke passes, Phone Auth send smoke reached test device | Capture OTP and finish real OTP verify smoke             |
