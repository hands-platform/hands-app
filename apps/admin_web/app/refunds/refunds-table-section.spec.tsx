...
function buildRow(): RefundTableRow {
  return {
    ...
    checklistRows: [
      { detail: 'Booking linked.', label: 'Booking record', pillClass: 'pill-success', required: true, status: 'Present' },
      { detail: 'Payment linked.', label: 'Payment record', pillClass: 'pill-success', required: true, status: 'Present' },
      { detail: 'Request linked.', label: 'Request context', pillClass: 'pill-success', required: true, status: 'Present' },
      { detail: 'Gateway linked.', label: 'Gateway evidence', pillClass: 'pill-success', required: true, status: 'Present' },
      { detail: 'Needs reconciliation.', label: 'State alignment', missingCategory: 'action-blocker', pillClass: 'pill-danger', required: true, status: 'Missing' },
    ],
