...
describe('ReferralDashboard', () => {
  ...
  it('renders policy controls and the hold-window release action', () => {
    ...
    expect(markup).toContain('class="admin-form-input referral-policy-input"');
    expect(markup).toContain('class="admin-form-textarea referral-policy-textarea"');
    expect(markup).toContain('class="admin-form-control-button button button-primary vuexy-customer-button referral-policy-save-button"');
