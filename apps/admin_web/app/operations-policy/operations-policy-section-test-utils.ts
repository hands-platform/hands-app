...
export function normalizedTextContent(value: unknown): string {
...
function renderKnownComponent(record: Record<string, unknown> | null) {
  ...
  if (
    ...
    ['AdminDataTable', 'AdminEmptyState', 'AdminSection', 'PillClassBadge', 'StatusBadge'].includes(component.name)
  ) {
