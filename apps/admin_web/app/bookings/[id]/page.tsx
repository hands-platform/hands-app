        ...
        <div className="ops-section-header">
          <div>
            ...
            <p className="muted">
              ...
              Partner app message when wallet debt blocks participation: Unpaid HANDS fees must be settled before you can join this marketplace booking.
            </p>
          </div>
    ...
    rows: [
      ...
      },
      {
        ...
        operatorUse: walletDebt
          ? 'Partner app message: Unpaid HANDS fees must be settled before you can join this marketplace booking. Collect the HANDS fee deposit or apply an approved offset before this partner can join new marketplace bookings.'
          : 'Partner app message: Unpaid HANDS fees must be settled before you can join this marketplace booking. No cash-fee wallet debt from this booking is currently gating marketplace participation.',
      },
      {
