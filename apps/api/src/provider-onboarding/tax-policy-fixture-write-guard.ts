const DISPOSABLE_DATABASE_PATTERN = /^(?:tax[_-]policy[_-](?:it|integration|smoke)|massage[_-]vn[_-]tax[_-]policy[_-](?:it|integration|smoke))_[a-z0-9_-]+$/u;
const DISPOSABLE_SCHEMA_PATTERN = /^tax_policy_(?:it|integration|smoke)_[a-z0-9_]+$/u;

export function assertTaxPolicyFixtureWriteEnvironment(
