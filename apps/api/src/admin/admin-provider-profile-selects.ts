...
export const ADMIN_PROVIDER_COMPACT_LIST_LIMIT = 100;
export const ADMIN_PROVIDER_DIRECTORY_LIST_LIMIT = 100;
export const ADMIN_PROVIDER_FILE_REVIEW_LIST_LIMIT = 100;
export const ADMIN_PROVIDER_LIST_AUDIT_LOG_LIMIT = 3;
export const ADMIN_PROVIDER_OPERATIONS_HANDOFF_LIST_LIMIT = 100;
export const ADMIN_PROVIDER_OPERATIONS_POLICY_LIST_LIMIT = 100;
export const ADMIN_PROVIDER_CONTROL_LIST_LIMIT = 100;
