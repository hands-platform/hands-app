...
class RealtimeSocket {
  ...
  io.Socket? _socket;
  final StreamController<void> _connectionEvents =
  ...
  Stream<void> get connectionEvents => _connectionEvents.stream;
  ...
  void updateLocation(
      {required double lat, required double lng, String? bookingId}) {
