...
import 'package:customer_app/src/features/notification/data/datasources/notification_remote_datasource.dart';
import 'package:customer_app/src/features/notification/data/datasources/push_token_datasource.dart';
import 'package:customer_app/src/features/notification/data/repositories/push_notification_repository_impl.dart';
import 'package:flutter_test/flutter_test.dart';

void main() {
  test('customer registers remote FCM tokens through the API', () async {
  ...
  test('customer skips remote registration for in-app-only tokens', () async {
    final remoteDataSource = _RecordingNotificationRemoteDataSource();
    final repository = PushNotificationRepositoryImpl(
      pushTokenDataSource: _FakePushTokenDataSource(
